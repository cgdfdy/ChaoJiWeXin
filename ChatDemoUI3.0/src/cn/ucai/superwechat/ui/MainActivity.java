...
//		mTabs[0].setSelected(true);
        ...
        adpter.clear();
        adpter.addFragment(contactListFragment, getString(R.string.app_name));
        ...
        adpter.addFragment(new SettingsActivity(), getString(R.string.me));
        ...
        mTitlePopup.addAction(new ActionItem(this, R.string.menu_groupchat, R.drawable.icon_groupinfo));
...
//		}
    ...
    protected void onNewIntent(Intent intent) {
        ...
        Boolean isBack =intent.getBooleanExtra(I.ACTION_BACK_CONVSERATION,false);
        if (isBack){
            layoutTabhost.setChecked(0);
        }
    }
