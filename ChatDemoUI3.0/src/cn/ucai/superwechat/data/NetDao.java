...
public class NetDao {
    ...
    public static void unregisterAppServer(Context context, String username, OkHttpUtils.OnCompleteListener<Result> listener) {
        OkHttpUtils<Result> utils = new OkHttpUtils<>(context);
    ...
    public static void loadContact(Context context, OkHttpUtils.OnCompleteListener<String> listener) {
        ...
        utils.setRequestUrl(I.REQUEST_DOWNLOAD_CONTACT_ALL_LIST)
                .addParam(I.User.USER_NAME, EMClient.getInstance().getCurrentUser())
                .targetClass(String.class)
                .execute(listener);
    }
